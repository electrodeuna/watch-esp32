...
void drawClockFace(){
  ...
  for(int i = 0; i<360; i+= 6) {
    ...
    tft.drawPixel(x0, yy0, BLUE);
    if(i==0 || i==180) tft.fillCircle(x0, yy0, 1, CYAN);
    if(i==0 || i==180) tft.fillCircle(x0+1, yy0, 1, CYAN);
    if(i==90 || i==270) tft.fillCircle(x0, yy0, 1, CYAN);
    if(i==90 || i==270) tft.fillCircle(x0+1, yy0, 1, CYAN);
  }
}
